...
MSG_HELLO, MSG_CAPS_OFFER, MSG_CAPS_REQUIRE, MSG_SESSION_OPEN, MSG_SESSION_CLOSE, \
    MSG_COMMAND_BATCH, MSG_RESOURCE_UPLOAD, MSG_QUERY, MSG_QUERY_RESULT, \
    MSG_FRAME_CHUNK, MSG_HEARTBEAT, MSG_ERROR, MSG_DEVICE_LOST = range(1, 14)
